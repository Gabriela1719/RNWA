...
<h1>Converter</h1>
	...
	<input style="padding:10px" type="submit" name="submit1" value="ConvertBAMtoHRK"> <input style="padding:10px"type="submit" name="submit2" value="ConvertHRKtoBAM">
    </form>
    ...
    <br /><br />
		...
		try{
			...
			$result=$ws->konverzijaHRKtoBAM($param)->konverzijaBAMtoHRKResult. ' KM';
			}else{
				$result=$ws->konverzijaBAMToEUR($param)->konverzijaBAMToEURResult. ' EUR';
				$result=$ws->konverzijaHRKtoBAM($param)->konverzijaBAMtoHRKResult. ' HRK';
			}
